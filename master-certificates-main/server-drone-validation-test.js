...
const opts = {
	key: fs.readFileSync(path.join(__dirname, '/server/server_key.pem')),
	cert: fs.readFileSync(path.join(__dirname, '/server/server_cert.pem')),
	requestCert: true,
	rejectUnauthorized: false, // so we can do own error handling
	ca: [
		fs.readFileSync(path.join(__dirname, '/ca/ca_cert.pem'))
	]
};
